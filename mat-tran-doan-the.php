...
// Lấy tin tức danh mục mặt trận đoàn thể
$news = [];
try {
    $conn = getDBConnection();
    $stmt = $conn->prepare("SELECT n.*, c.name as category_name FROM news n 
                            LEFT JOIN categories c ON n.category_id = c.id 
                            WHERE c.slug = 'mat-tran' AND n.status = 'published' 
...
<head>
    ...
    <title>Mặt trận đoàn thể - UBND Xã Long Hiệp</title>
...
<body>
    ...
    <main>
        <section class="page-header">
            <div class="container">
                <h2>Mặt trận đoàn thể</h2>
                <p>Hoạt động của Mặt trận Tổ quốc và các đoàn thể tại xã Long Hiệp</p>
                <?php if ($isLoggedIn): ?>
                    <div style="margin-top: 20px;">
                        <a href="them-tin.php?cat=mat-tran" class="btn-primary" style="display: inline-block; padding: 12px 24px; background: #28a745; color: white; text-decoration: none; border-radius: 8px; font-weight: 600;">
                            ➕ Thêm tin tức mới
                        </a>
                    </div>
                <?php endif; ?>
                                    ...
                                    <div class="news-actions">
                                        ...
                                        <?php if ($isLoggedIn && authCanManageContent()): ?>
                                            <div class="admin-buttons">
                                                ...
                                                <a href="xoa-tin.php?id=<?php echo $item['id']; ?>&cat=mat-tran" 
