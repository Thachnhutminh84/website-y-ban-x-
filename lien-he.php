        ...
        <section class="contact">
            <div class="container">
                ...
                <div class="map-section">
                    <h3>Vị trí địa lý</h3>
                    <div class="map-container" style="background: var(--gradient-primary); border-radius: 12px; padding: 60px 40px; text-align: center; color: white; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                        <div style="font-size: 72px; margin-bottom: 20px;">📍</div>
                        <h4 style="font-size: 24px; margin: 0 0 15px 0; font-weight: 700;">Xã Long Hiệp, Tỉnh Vĩnh Long</h4>
                        <p style="font-size: 16px; margin: 0 0 10px 0; opacity: 0.95;">Tọa độ: 10°03'00.0"N 105°57'00.0"E</p>
                        <p style="font-size: 14px; margin: 0 0 30px 0; opacity: 0.85;">Cách trung tâm tỉnh Vĩnh Long khoảng 15 km</p>
                        <a href="https://www.google.com/maps/search/?api=1&query=Xã+Long+Hiệp+Vĩnh+Long" 
                           target="_blank" 
                           style="display: inline-block; background: white; color: var(--primary); padding: 12px 30px; border-radius: 25px; text-decoration: none; font-weight: 600; font-size: 15px; box-shadow: 0 4px 10px rgba(0,0,0,0.15); transition: all 0.3s;">
                            🗺️ Xem trên Google Maps
                        </a>
                    </div>
                    <div class="map-info" style="margin-top: 20px; padding: 20px; background: #f8f9fa; border-radius: 8px;">
                        <p style="margin: 0 0 10px 0;"><strong>📍 Địa chỉ:</strong> Xã Long Hiệp, Tỉnh Vĩnh Long</p>
                        <p style="margin: 0 0 10px 0;"><strong>📞 Điện thoại:</strong> Đang cập nhật</p>
                        <p style="margin: 0;"><strong>📧 Email:</strong> ubnd@longhiep.gov.vn</p>
                    </div>
                </div>
            </div>
        </section>
