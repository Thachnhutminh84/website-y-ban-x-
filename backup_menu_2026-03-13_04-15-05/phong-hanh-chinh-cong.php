...
$department = $departments['hanh-chinh-cong'];
            ...
            <div class="container">
                <div class="dept-layout">
                    <article class="dept-panel dept-panel--wide">
                        ...
                        <p class="dept-lead">
                            <?php echo htmlspecialchars($department['name'], ENT_QUOTES, 'UTF-8'); ?> là đầu mối tiếp nhận và giải quyết
                            các thủ tục hành chính cho người dân và doanh nghiệp theo cơ chế một cửa, một cửa liên thông.
                            Mục tiêu của bộ phận là rút ngắn thời gian, đơn giản hóa thủ tục và nâng cao chất lượng phục vụ,
                            tạo điều kiện thuận lợi nhất cho người dân trong việc giải quyết các công việc hành chính.
                        </p>
                    </article>
