            ...
            <div class="container">
                ...
                <?php elseif (!$pageError): ?>
                    <div class="empty-panel">
                        ...
                        <?php if ($canManageNews): ?>
                            <a href="them-tin.php?cat=<?php echo htmlspecialchars($addNewsCategory, ENT_QUOTES, 'UTF-8'); ?>" style="display: inline-block; margin-top: 20px; padding: 12px 24px; background: var(--primary); color: white; text-decoration: none; border-radius: 8px;">+ Thêm tin tức đầu tiên</a>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
            </div>
