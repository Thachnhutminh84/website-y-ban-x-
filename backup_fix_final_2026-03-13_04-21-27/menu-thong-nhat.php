    ...
    <ul class="menu">
        <?php if ($isLoggedIn): ?>
            ...
            <?php foreach ($adminMenu as $item): ?>
                <li class="menu-item <?php echo isset($item['dropdown']) ? 'dropdown' : ''; ?>">
                    <a href="<?php echo $item['url']; ?>" class="<?php echo activeClass($item['pages']); ?>">
            ...
            <!-- Thông tin admin -->
            <li class="admin-info">
                👤 <?php echo htmlspecialchars(function_exists('authRoleLabel') ? authRoleLabel($currentRole) : $currentRole, ENT_QUOTES, 'UTF-8'); ?>
