...
$quickLinks = [
    ...
    ['title' => 'Thủ tục - biểu mẫu', 'description' => 'Tra cứu 410 thủ tục hành chính, thành phần hồ sơ và thời hạn giải quyết.', 'href' => 'thu-tuc-hanh-chinh.php'],
...
$communityFacts = [
    'Long Hiệp là xã nông thôn mới, cách trung tâm tỉnh khoảng 90 km về phía Nam với tổng diện tích tự nhiên 6.516,77 ha.',
...
<head>
    ...
    <link rel="stylesheet" href="home-style.css?v=1.1">
    <script src="dropdown.js"></script>
</head>
<body>
    <!-- Header thống nhất với style trang chủ -->
    ...
    <main class="home-page">
            ...
            <div class="container home-hero__grid">
                <div class="home-hero__content">
                    ...
                    <div class="home-hero__actions">
                        ...
                        <a href="thu-tuc-hanh-chinh.php" class="home-btn home-btn--ghost">Tra cứu thủ tục</a>
                    </div>
                ...
                <div class="home-media-card">
                    <div class="home-video-shell">
                        <video controls preload="metadata">
                            <source src="images/7586381057818.mp4" type="video/mp4">
                            Trình duyệt của bạn không hỗ trợ video HTML5.
                        </video>
                    </div>
                    <div class="home-media-card__caption">
                        <strong>Hạ tầng dân sinh và không gian văn hóa cộng đồng</strong>
                        <span>Giáo dục, y tế và đời sống tín ngưỡng là những nền tảng quan trọng của xã Long Hiệp.</span>
                    </div>
        ...
        <section class="home-section">
            <div class="container home-map-grid">
                <div class="home-panel">
                    <div class="home-section__heading home-section__heading--left">
                        <span class="home-kicker home-kicker--soft">Bản đồ vị trí</span>
                        <h2>Vị trí và kết nối địa bàn</h2>
                    </div>
                    <div class="home-map-shell">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d125449.85894814384!2d105.93!3d10.25!2m3!1f0!2f0!3f0!2f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTDCsDE1JzAwLjAiTiAxMDXCsDU1JzQ4LjAiRQ!5e0!3m2!1svi!2s!4v1234567890"
                            loading="lazy"
                            referrerpolicy="no-referrer-when-downgrade"
                            allowfullscreen>
                        </iframe>
                    </div>
                    <p class="home-map-note">
                        Phía Đông giáp xã Hiệp Mỹ và Ngũ Lạc; phía Tây giáp xã Trà Cú; phía Nam giáp xã Đôn Châu và xã Hàm Giang;
                        phía Bắc giáp xã Tập Sơn và xã Nhị Trường.
                    </p>
                </div>
