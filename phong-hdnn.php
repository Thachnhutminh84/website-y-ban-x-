            ...
            <div class="container">
                <div class="dept-layout">
                    <article class="dept-panel dept-panel--wide">
                        ...
                        <p class="dept-lead">
                            <?php echo htmlspecialchars($department['name'], ENT_QUOTES, 'UTF-8'); ?> là cơ quan quyền lực nhân dân cấp xã,
                            đại diện cho ý chí, nguyện vọng của nhân dân địa phương. HĐNN có nhiệm vụ lập pháp, giám sát hoạt động của UBND xã
                            và các cơ quan khác, quyết định các vấn đề quan trọng liên quan đến lợi ích chung của nhân dân.
                            Mục tiêu của HĐNN là bảo vệ quyền lợi hợp pháp của nhân dân và thúc đẩy phát triển kinh tế - xã hội bền vững.
                        </p>
                    </article>
        ...
        <section class="dept-section">
            <div class="container">
                <div class="dept-section-heading">
                    ...
                    <h3>Danh sách cán bộ, ủy viên</h3>
            ...
            <div class="modal-body">
                ...
                <form id="staffForm">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="staffName">Tên ủy viên/cán bộ *</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="staffRole" class="form-control" required placeholder="Ví dụ: Ủy viên HĐND, Chủ tịch HĐND...">
                    </div>
                    <div class="form-group">
