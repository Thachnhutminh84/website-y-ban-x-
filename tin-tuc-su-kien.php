            ...
            <div class="container">
                ...
                <?php if ($isLoggedIn): ?>
                    <div style="margin-top: 20px;">
                        <a href="them-tin.php?cat=su-kien" class="btn-primary" style="display: inline-block; padding: 12px 24px; background: #28a745; color: white; text-decoration: none; border-radius: 8px; font-weight: 600;">
                            ➕ Thêm tin tức mới
                        </a>
                    </div>
                <?php endif; ?>
