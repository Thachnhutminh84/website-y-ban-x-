            ...
            <div class="container">
                ...
                <?php if ($isLoggedIn): ?>
                    <div style="margin-top: 20px;">
                        <a href="them-tin.php?cat=xay-dung-dang" class="btn-primary" style="display: inline-block; padding: 12px 24px; background: #28a745; color: white; text-decoration: none; border-radius: 8px; font-weight: 600;">
                            ➕ Thêm tin tức mới
                        </a>
                    </div>
                <?php endif; ?>
                                    ...
                                    <div class="news-actions">
                                        ...
                                        <?php if ($isLoggedIn && authCanManageContent()): ?>
                                            <div class="admin-buttons">
                                                ...
                                                <a href="xoa-tin.php?id=<?php echo $item['id']; ?>&cat=xay-dung-dang" 
